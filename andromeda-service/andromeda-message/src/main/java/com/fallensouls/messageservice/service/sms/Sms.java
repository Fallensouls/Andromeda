package com.fallensouls.messageservice.service.sms;
...
//        request.setTemplateParam("{\"name\":\"Tom\", \"code\":\"123\"}");
        if(args != null) {
            request.setTemplateParam(args[0]);
        }
    ...
    public void queryDetails(SendSmsResponse response) throws ClientException, InterruptedException {
